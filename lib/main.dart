...
const AUTH0_CLIENT_ID = 'a9a03c38-e002-4426-b817-90d1cc212f3b';
...
class _MyAppState extends State<MyApp> {
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          actions: isBusy
              ? <Widget>[
                  IconButton(
                    icon: const Icon(Icons.sip_outlined),
  ...
  Future<Map<String, dynamic>> getUserDetails(String accessToken) async {
    final url =
        'https://graph.microsoft.com/oidc/userinfo'; //'https://$AUTH0_DOMAIN/userinfo';
